    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'laravel-mpdf' => \Mccarlosen\LaravelMpdf\LaravelMpdfWrapper::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/alhamza/Projects/web/pbs/public/storage' => 'string',
            ...
            'firebase.projects.app.database.url' => 'string',
            ...
            'l5-swagger.defaults.constants.APP_VERSION' => 'string',
            'l5-swagger.defaults.constants.APP_TITLE' => 'string',
            'l5-swagger.enabled' => 'boolean',
            'l5-swagger.swagger_auth.user' => 'string',
            'l5-swagger.swagger_auth.pass' => 'string',
            ...
            'mail.mailers.brevo.dsn' => 'string',
            'mail.from.address' => 'string',
            'mail.from.name' => 'string',
            'mail.markdown.theme' => 'string',
            'mail.markdown.paths' => 'array',
            'mypdf.disk' => 'string',
            'mypdf.mpdf.showImageErrors' => 'boolean',
            'mypdf.mpdf.debug' => 'boolean',
            'mypdf.mpdf.autoScriptToLang' => 'boolean',
            'mypdf.mpdf.autoLangToFont' => 'boolean',
            'mypdf.mpdf.allow_charset_conversion' => 'boolean',
            'mypdf.mpdf.useKerning' => 'boolean',
            'mypdf.mpdf.useLigatures' => 'boolean',
            'mypdf.mpdf.jpeg_quality' => 'integer',
            'pdf.mode' => 'string',
            'pdf.format' => 'string',
            ...
            'pdf.show_watermark_image' => 'boolean',
            'pdf.watermark_font' => 'string',
            'pdf.display_mode' => 'string',
            'pdf.watermark_text_alpha' => 'double',
            'pdf.watermark_image_path' => 'string',
            'pdf.watermark_image_alpha' => 'double',
            'pdf.watermark_image_size' => 'string',
            'pdf.watermark_image_position' => 'string',
            'pdf.custom_font_dir' => 'string',
            'pdf.custom_font_data.rubic.R' => 'string',
            'pdf.custom_font_data.rubic.B' => 'string',
            'pdf.custom_font_data.rubic.I' => 'string',
            'pdf.custom_font_data.rubic.BI' => 'string',
            'pdf.custom_font_data.rubic.useOTL' => 'integer',
            'pdf.custom_font_data.rubic.useKashida' => 'integer',
            'pdf.custom_font_data.notosans.R' => 'string',
            'pdf.custom_font_data.notosans.useOTL' => 'integer',
            'pdf.custom_font_data.notosans.useKashida' => 'integer',
            'pdf.custom_font_data.dejavusans.R' => 'string',
            'pdf.custom_font_data.dejavusans.B' => 'string',
            'pdf.custom_font_data.dejavusans.I' => 'string',
            'pdf.custom_font_data.dejavusans.BI' => 'string',
            'pdf.custom_font_data.dejavusans.useOTL' => 'integer',
            'pdf.custom_font_data.dejavusans.useKashida' => 'integer',
            'pdf.custom_font_data.xbzar.R' => 'string',
            'pdf.custom_font_data.xbzar.B' => 'string',
            'pdf.custom_font_data.xbzar.I' => 'string',
            'pdf.custom_font_data.xbzar.BI' => 'string',
            'pdf.custom_font_data.xbzar.useOTL' => 'integer',
            'pdf.custom_font_data.xbzar.useKashida' => 'integer',
            'pdf.auto_language_detection' => 'boolean',
            'pdf.temp_dir' => 'string',
            'pdf.pdfa' => 'boolean',
            'pdf.pdfaauto' => 'boolean',
            'pdf.use_active_forms' => 'boolean',
            'pdf.debug.mpdf' => 'boolean',
            'pdf.debug.fonts' => 'boolean',
            'pdf.debug.show_warnings' => 'boolean',
            ...
            'services.brevo.sender_email' => 'string',
            'services.brevo.sender_name' => 'string',
            'services.mindee.api_key' => 'string',
            'services.mindee.model_id' => 'string',
...
'app.aliases.Vite','app.app_version','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.links./Users/alhamza/Projects/web/pbs/public/storage','firebase.default','firebase.projects.app.credentials','firebase.projects.app.auth.tenant_id','firebase.projects.app.firestore',
...
'firebase.projects.app.logging.http_debug_log_channel','firebase.projects.app.http_client_options.proxy','firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','l5-swagger.default',
...
'l5-swagger.defaults.constants.APP_VERSION','l5-swagger.defaults.constants.APP_TITLE','l5-swagger.enabled','l5-swagger.swagger_auth.user','l5-swagger.swagger_auth.pass',
...
'mail.mailers.failover.mailers','mail.mailers.roundrobin.transport','mail.mailers.roundrobin.mailers','mail.mailers.brevo.transport','mail.mailers.brevo.dsn',
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','mypdf.disk',
'mypdf.mpdf.showImageErrors','mypdf.mpdf.debug','mypdf.mpdf.autoScriptToLang','mypdf.mpdf.autoLangToFont','mypdf.mpdf.allow_charset_conversion',
'mypdf.mpdf.useKerning','mypdf.mpdf.useLigatures','mypdf.mpdf.jpeg_quality','pdf.mode','pdf.format',
'pdf.default_font_size','pdf.default_font','pdf.margin_left','pdf.margin_right','pdf.margin_top',
'pdf.margin_bottom','pdf.margin_header','pdf.margin_footer','pdf.orientation','pdf.title',
'pdf.subject','pdf.author','pdf.watermark','pdf.show_watermark','pdf.show_watermark_image',
'pdf.watermark_font','pdf.display_mode','pdf.watermark_text_alpha','pdf.watermark_image_path','pdf.watermark_image_alpha',
'pdf.watermark_image_size','pdf.watermark_image_position','pdf.custom_font_dir','pdf.custom_font_data.rubic.R','pdf.custom_font_data.rubic.B',
'pdf.custom_font_data.rubic.I','pdf.custom_font_data.rubic.BI','pdf.custom_font_data.rubic.useOTL','pdf.custom_font_data.rubic.useKashida','pdf.custom_font_data.notosans.R',
'pdf.custom_font_data.notosans.useOTL','pdf.custom_font_data.notosans.useKashida','pdf.custom_font_data.dejavusans.R','pdf.custom_font_data.dejavusans.B','pdf.custom_font_data.dejavusans.I',
'pdf.custom_font_data.dejavusans.BI','pdf.custom_font_data.dejavusans.useOTL','pdf.custom_font_data.dejavusans.useKashida','pdf.custom_font_data.xbzar.R','pdf.custom_font_data.xbzar.B',
'pdf.custom_font_data.xbzar.I','pdf.custom_font_data.xbzar.BI','pdf.custom_font_data.xbzar.useOTL','pdf.custom_font_data.xbzar.useKashida','pdf.auto_language_detection',
'pdf.temp_dir','pdf.pdfa','pdf.pdfaauto','pdf.use_active_forms','pdf.debug.mpdf',
'pdf.debug.fonts','pdf.debug.show_warnings','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.brevo.key','services.brevo.sender_email','services.brevo.sender_name',
'services.mindee.api_key','services.mindee.model_id','session.driver','session.lifetime','session.expire_on_close',
...
'signed','throttle','verified','swagger.auth','permission',
'role','role_or_permission',);
        registerArgumentsSet('routes', 
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','buildings.image','units.floor_plan','bookings.download_document',
'stamp.image','translate.ar','translate.ar.multiple','signatures.image','general-settings.index','general-settings.store','general-settings.show','general-settings.update',
'general-settings.destroy','storage.local',);
        registerArgumentsSet('views', 
'components.contract-bilingual-row','emails.broker_agreement','emails.installment_reminder','emails.otl','emails.reset_password',
'emails.rf_spa_final','emails.signature_link','emails.user_approved','l5-swagger::index','pdf.broker_agreement',
'pdf.invoice','pdf.reservation_form','pdf.sales_offer','pdf.sales_offer2','pdf.spa',
'pdf.spa2','vendor.l5-swagger.index','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'APP_NAME','APP_VERSION','APP_ENV','APP_KEY','APP_DEBUG',
'APP_URL','FEND_URL','TENANT_NAME','TENANT_NAME_AR','TENANT_LICENSE',
'TENANT_DLD','TENANT_EMAIL','TENANT_PHONE','TENANT_PO_BOX','TENANT_ADDRESS',
'TENANT_ADDRESS_AR','TENANT_ACCOUNT_BANK','TENANT_ACCOUNT_BRANCH','TENANT_ACCOUNT_NAME','TENANT_ACCOUNT_NUMBER',
'TENANT_ACCOUNT_IBAN','TENANT_ACCOUNT_SWIFT','TENANT_ESCROW_ACCOUNT_BANK','TENANT_ESCROW_ACCOUNT_NAME','TENANT_ESCROW_ACCOUNT_BRANCH',
'TENANT_ESCROW_ACCOUNT_NUMBER','TENANT_ESCROW_ACCOUNT_IBAN','TENANT_ESCROW_ACCOUNT_BIC','L5_SWAGGER_CONST_HOST','L5_SWAGGER_ENABLED',
'SWAGGER_USER','SWAGGER_PASS','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'REDIS_PASSWORD','REDIS_PORT','BREVO_API_KEY1','MAIL_MAILER','MAIL_DSN',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MINDEE_API_KEY','MINDEE_MODEL_ID',
'FIREBASE_DATABASE_URL','FIREBASE_CREDENTIALS','BREVO_API_KEY2','BREVO_SENDER_EMAIL','BREVO_SENDER_NAME',);
