...
<div class="container">
    ...
    <div class="content">
        ...
        <p style="text-align:center; margin: 22px 0;">
            <a class="btn" href="{{ config('app.frontend_url') }}/one-time-links/register/Broker/{{ $otl->token }}">
                Register
            </a>
        </p>
        ...
        <blockquote cite="{{ config('app.frontend_url') }}/one-time-links/register/Broker/{{ $otl->token }}">
            {{ config('app.frontend_url') }}/one-time-links/register/Broker/{{ $otl->token }}
        </blockquote>
